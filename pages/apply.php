...
<section id="innerHero" class="hero">
    <div class="content">
        ...
        <div class="titleContainer" style="max-height: 400px;">
            <div class="title">
...
<section id="article_content" class="patternBg application_container">

    <div class="content">
        <article>
            <h2>Position: UI/UX Designer</h2>
            <p>Please fill out the form below and attach your CV to apply for the above position and one of our expert recruiters will contact you shortly.</p>
        <?php
