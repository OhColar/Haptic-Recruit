<?php
    ...
    $result = mysql_query("UPDATE blog SET slug = '$slug_title_new', title = '$title_new', post_date = '$post_date_new', content = '$content_new', meta_description = '$meta_description_new', image = '$image_new' WHERE id='$post'") or die(mysql_error());

    echo "<div class=\"success\"><p><img src=\"images/yes.svg\"> Wahoo! Post successfully updated.</p></div>";

    }

    // get current post data
    
    $result = mysql_query("SELECT * FROM blog WHERE id = $post");
...
<h1>Edit Post: <?php echo $title; ?></h1>
    ...
    <form method="post" action="?app=edit_blog&post=<?php echo $post; ?>">
        <div class="formRow">
        ...
        <div class="formRow submit_form_container">
            <a href="/blog/<?php echo $slug; ?>" target="_blank">Preview Post</a>
